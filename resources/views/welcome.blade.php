                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="/admin/login"
                            ...
                            <div class="pt-3 sm:pt-5 w-full">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Admin Login details: </h2>
                        ...
                        <a href="/vendors/login"
                            ...
                            <div class="pt-3 sm:pt-5 w-full">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Vendor Login details: </h2>
                                <p class="mt-4 text-sm/relaxed">
                                    URL :
                                    <pre>/vendors/login</pre>
                                </p>
                                <p class="mt-4 text-sm/relaxed">
                                    Email :
                                    <pre>vendor@local.test</pre>
                                </p>
                                <p class="mt-4 text-sm/relaxed">
                                    Password :
                                    <pre>password</pre>
                        ...
                        <a href="/user/login"
                            ...
                            <div class="pt-3 sm:pt-5 w-full">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Guest Login details: </h2>
                                <p class="mt-4 text-sm/relaxed">
                                    URL :
                                    <pre>/user/login</pre>
                                </p>
